...
def parse_args():
    ...
    parser.add_argument('--eval_imgs', dest='eval_imgs',
                        ...
                        default='/unsullied/sharefs/yangxue/isilon/yangxue/data/BDD100K/BDD100K_VOC/bdd100k_val/val', type=str)
    parser.add_argument('--annotation_dir', dest='test_annotation_dir',
                        help='the dir save annotations',
                        default='/unsullied/sharefs/yangxue/isilon/yangxue/data/BDD100K/BDD100K_VOC/bdd100k_val/Annotations', type=str)
